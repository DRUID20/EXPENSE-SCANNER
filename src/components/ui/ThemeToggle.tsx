...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="relative w-12 h-6 rounded-full bg-gray-200 dark:bg-white/[0.08] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:ring-offset-0"
    >
      <motion.div
