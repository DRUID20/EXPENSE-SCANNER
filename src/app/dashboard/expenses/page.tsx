    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
      ...
      {selected.size > 0 && (
        <motion.div
          ...
          className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-orange-50 dark:bg-orange-950/50 border border-orange-200 dark:border-orange-800"
        >
          ...
          {bulkLoading ? (
            ...
            <>
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-blue-100 dark:bg-blue-950 text-blue-600 dark:text-blue-400 text-xs font-medium hover:bg-blue-200 dark:hover:bg-blue-900 transition-colors"
              >
              ...
              {user?.role !== "EMPLOYEE" && (
                <>
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-green-100 dark:bg-green-950 text-green-600 dark:text-green-400 text-xs font-medium hover:bg-green-200 dark:hover:bg-green-900 transition-colors"
                  >
                    <CheckCircle2 className="w-3 h-3" /> Approve
                  </button>
                  <button
                    onClick={() => handleBulkAction("reject")}
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-red-100 dark:bg-red-950 text-red-600 dark:text-red-400 text-xs font-medium hover:bg-red-200 dark:hover:bg-red-900 transition-colors"
                  >
        ...
        <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-16">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            {!search && statusFilter === "ALL" && (
              <div className="flex gap-3">
                <Link href="/dashboard/scan">
                  <motion.button whileHover={{ scale: 1.02 }} className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold text-sm shadow-lg shadow-orange-500/25">
                    <ScanLine className="w-4 h-4" /> Scan Receipt
                  </motion.button>
                </Link>
                <Link href="/dashboard/expenses/new">
                  <motion.button whileHover={{ scale: 1.02 }} className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 font-medium">
              ...
              {expenses.map((expense, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`group rounded-2xl bg-white dark:bg-gray-900 border p-5 transition-colors ${isSelected ? "border-orange-300 dark:border-orange-700 bg-orange-50/50 dark:bg-orange-950/20" : "border-gray-200 dark:border-gray-800 hover:border-orange-200 dark:hover:border-orange-800"}`}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                          ...
                          {!isOwner && (
                            <span className="text-xs">by {expense.user.firstName} {expense.user.lastName}</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <Link href={`/dashboard/expenses/${expense.id}`}>
                          <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-950 transition-colors" title="View details">
          ...
          {pages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-6">
              <button
                ...
                disabled={page === 1}
                className="px-3 py-1.5 rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-sm text-gray-600 dark:text-gray-400 disabled:opacity-30 hover:border-orange-300 transition-colors"
              >
                Previous
              </button>
